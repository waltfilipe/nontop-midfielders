...
const MODULES = [
  {
    href: "/reports",
    title: "Reports",
    description: "Relatórios PDF-ready de meio-campistas — grades xP, pass scores e mapas por categoria etária.",
    icon: "fa-file-lines",
    accent: "#a78bfa",
    featured: true,
  },
    ...
    <div className="container home-page">
      <section className="home-intro">
        ...
        <p className="home-lead">
          Análise de passes de meio-campistas nas 6 ligas europeias — xP M4, ratings de
          progressão e perfis comparativos dentro do pool.
        </p>
        <div className="home-stats">
          ...
          <span className="home-stat">
            <strong>{meta.leagues.length || 6}</strong> ligas
          </span>
          <span className="home-stat-sep" aria-hidden="true" />
          <span className="home-stat">
