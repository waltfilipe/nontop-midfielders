...
const en: Messages = {
  ...
  players: {
    subtitle: "Satellite European league midfielders with pass ratings and position-pool pillars.",
...
const pt: Messages = {
  ...
  players: {
    subtitle: "Meio-campistas de ligas satélite europeias com ratings de passe e pilares por pool.",
  ...
  reports: {
    ...
    pageFootnote: "atletas · pool meio-campistas · 6 ligas satélite",
