    ...
    <div className={`reports-page${printing ? " reports-printing" : ""}`}>
        ...
        <div className="reports-hero-main">
          <div className="reports-hero-copy">
            ...
            <p className="reports-hero-lead">
              Perfis curados em 3 faixas etárias — overview xP, pass scores, consistency e mapas
              de passe. Exportação PDF por atleta ou em lote.
            </p>
          </div>
      ...
      <p className="reports-hint muted report-screen-only">
        {bootLoading
          ...
          : reports.length === 0
            ? "Nenhum jogador selecionado para reports ainda."
            : `${okCount} prontos · mapas carregam ao abrir ou ao exportar PDF`}
      </p>

      {!bootLoading && reports.length === 0 && (
        <div className="card reports-empty-state report-screen-only">
          <p className="muted" style={{ marginBottom: "0.5rem" }}>
            A estrutura de reports está pronta — categorias U23, 24–30 e 30+.
          </p>
          <p className="muted">
            Os jogadores serão adicionados em breve. Use Profile, Compare, Maps e Players para
            explorar o pool atual.
          </p>
        </div>
      )}

      {bootLoading && reports.length > 0 && loadingCount === reports.length && (
